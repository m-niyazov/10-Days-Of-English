...
final class DataManager {
    ...
    func daysListUpdate(){
        let day1 = Day(whichDay: 1,
                       ...
                       importantNoteText: "Нужно запомнить, что серию ты смотришь не для того, чтобы развлечься, а только с целью выучить новые слова.",
                       additionalInfo: "Эти слова уже есть в твоём пассивном словарном запасе. Чтобы «добить» их, попробуй написать словосочетания с ними."
